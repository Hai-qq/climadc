...
_DELTA_LABELS = {
    ...
    "emissions_change_vs_asap_kgco2e": "emissions",
...
_ROBUSTNESS_COLUMNS = (
    ...
    "mean_emissions_change_vs_asap_kgco2e",
    "worst_emissions_change_vs_asap_kgco2e",
...
class ReplaySuiteConfig(BaseModel):
    """Strict configuration for an equal-weight collection of replay studies."""
...
class ReplaySuiteResult:
    ...
    _robustness_metrics: pd.DataFrame
    ...
    def __init__(
        ...
        *,
        ...
        object.__setattr__(self, "_robustness_metrics", robustness_metrics.copy(deep=True))
    ...
    def robustness_metrics(self) -> pd.DataFrame:
        return cast(pd.DataFrame, self._robustness_metrics.copy(deep=True))
    ...
    for policy in policies:
        ...
        for delta_column in _DELTA_COLUMNS:
            ...
            if label == "energy_cost":
                ...
                record["mean_emissions_change_vs_asap_kgco2e"] = mean
                record["worst_emissions_change_vs_asap_kgco2e"] = worst
...
class ReplaySuiteRunner:
    """Run comparable verified studies and summarize cross-scenario robustness."""
    ...
    def run(self, config: ReplaySuiteConfig) -> ReplaySuiteResult:
        ...
        robustness, pareto = _robustness_metrics(
            scenario_metrics,
            policies,
            len(scenarios),
        )
